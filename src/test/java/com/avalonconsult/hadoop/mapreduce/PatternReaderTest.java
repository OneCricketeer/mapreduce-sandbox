...
public class PatternReaderTest extends LocalFileReaderTest {
    ...
    @Test
    public void testPatternHeadAndInside()
            throws URISyntaxException, IOException, InterruptedException {
    ...
    private PatternRecordReader getPatternRecordReader(Configuration conf, String pattern, FileSplit split)
